    ...
    tabItems(
      ...
      tabItem(tabName = "plots",
              ...
              tabsetPanel(type = "tabs", 
                          ...
                          tabPanel("Price Changes over Time", 
                          ...
                          tabPanel("Category Changes by Year", 
                          ...
                          tabPanel("Consumer vs Producer", 
                                   style = "height: 600px; width: 100%",
                                   htmlOutput("plot_food_vs_producer"),
                                   hr(),
                                   selectInput("foodCategoryProducer", "Producer Food Categories (multiple allowed):",
                                               multiple = TRUE,
